...
set(_exported_dependencies "autoware_adapi_v1_msgs;autoware_control_msgs;autoware_motion_utils;autoware_mpc_lateral_controller;autoware_pid_longitudinal_controller;autoware_planning_msgs;autoware_pure_pursuit;autoware_trajectory_follower_base;autoware_utils;autoware_vehicle_info_utils;autoware_vehicle_msgs;rclcpp;rclcpp_components;visualization_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to autoware_trajectory_follower_node_DEFINITIONS, autoware_trajectory_follower_node_INCLUDE_DIRS,
# autoware_trajectory_follower_node_LIBRARIES, and autoware_trajectory_follower_node_LINK_FLAGS.
# Additionally collect the direct dependency names in
# autoware_trajectory_follower_node_DEPENDENCIES as well as the recursive dependency names
# in autoware_trajectory_follower_node_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(autoware_trajectory_follower_node_DEPENDENCIES ${_exported_dependencies})
  set(autoware_trajectory_follower_node_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(autoware_trajectory_follower_node_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(autoware_trajectory_follower_node_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(autoware_trajectory_follower_node_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(autoware_trajectory_follower_node_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(autoware_trajectory_follower_node_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND autoware_trajectory_follower_node_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
