...
{
public:
  explicit EmptyObjectsPublisher(const rclcpp::NodeOptions & options)
  : Node("empty_objects_publisher", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::dummy_perception_publisher::EmptyObjectsPublisher)
