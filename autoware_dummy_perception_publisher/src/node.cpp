...
DummyPerceptionPublisherNode::DummyPerceptionPublisherNode(const rclcpp::NodeOptions & options)
: Node("dummy_perception_publisher", options), tf_buffer_(this->get_clock()), tf_listener_(tf_buffer_)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::dummy_perception_publisher::DummyPerceptionPublisherNode)
